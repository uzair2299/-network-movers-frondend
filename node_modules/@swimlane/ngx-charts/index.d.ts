...
import { OnChanges, EventEmitter, ElementRef, NgZone, AfterViewInit, OnDestroy, OnInit, ChangeDetectorRef, SimpleChanges, TemplateRef, Renderer2, ViewContainerRef, ApplicationRef, Injector, ComponentRef, Type, TrackByFunction, QueryList } from '@angular/core';
...
declare class SankeyComponent extends BaseChartComponent {
    ...
    activate: EventEmitter<any>;
    deactivate: EventEmitter<any>;
    labelElements: QueryList<ElementRef<SVGTextElement>>;
    tooltipTemplate: TemplateRef<any>;
    dims: ViewDimensions;
    colors: ColorHelper;
    colorScale: any;
